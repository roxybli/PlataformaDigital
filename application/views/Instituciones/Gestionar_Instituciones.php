  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclose="true">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group">   
                                <input type="text" class="form-control" id="val-name" name="Nombre_Institucion" placeholder="Nombre de la Institución"  onkeyup="this.value=NumText(this.value)" required>
                            </div>
                        </div>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="location.href='<?=base_url()?>Instituciones/'"  >Cancelar</button>
            ...
            <form class="form-valide" action="<?=base_url()?>Instituciones/Editar" method="post">         
                <div class="row ">
                    <div class="col-md-12">
                        <div class="form-group">
                            <div class="input-group">   
                                <input type="text" class="form-control" id="val-name" id="Nombre_Institucion2" name="Nombre_Institucion2" placeholder="Nombre de la Institución"  onkeyup="this.value=NumText(this.value)" required>
