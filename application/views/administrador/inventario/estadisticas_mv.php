...
<div class="row page-titles" style="background:#000d5a;">
    ...
    <div class="col-md-5 align-center">
        <h3 style="color: #fff">Estadisticas de Ventas Realizadas </h3>
     </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body" >
                <div><strong><h3  style="color: #000000 " align="center">Estadística mensual</h3></strong><br>  
                    <form class="form" method="post" action="<?= base_url() ?>Inventario/estadisticaVR">
                        <div class="row ">
                            <div class="col-md-2">
