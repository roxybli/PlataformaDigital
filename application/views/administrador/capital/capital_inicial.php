                        ...
                        <div class="row ">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="materiaComestible" min="0" name="" placeholder="Número de Insumos" onkeypress="return numeros(event, 'num')" maxlength="20" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <label for="" style="color: #000000">Cantidad de Maquinaria</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="maquinaria" name="" min="0" placeholder="Número de maquinaria" onkeypress="return numeros(event, 'num')" maxlength="20" required>
