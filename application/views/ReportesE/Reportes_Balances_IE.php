 ...
 <!-- Bread crumb -->
        ...
        <a href="<?= base_url() ?>ReportesEU/ReportesPDF"><h3 class="text-primary"><i class="fa fa-chevron-left"></i> Volver</h3></a>
                ...
                <div class="col-md-9 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Reportes de Balances</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row ">
                    <div class="card TituloUser">
                                    <h3 class="responsive" style="color:white; font-weight:bold;">Crear Reportes de balances de ingresos y egresos</h3>
                                </div>
                    <div class="col-sm-12">
                        <div class="card">
                                ...
                                <div class="col-md-4">
                                 ...
                                 Reportes por Fechas
                                    ...
                                    <p>Este reporte genera un documento de registro de balances de ingresos y egresos según la fecha seleccionada en el cual se muestra la siguiente información:</p>
                                    <ul>
                                    <li>- Fecha </li>
                                    <li>- Operación </li>
                                    <li>- Egreso de dinero</li>
                                    <li>- Ingreso</li>
                                    <li>- Total de Balance</li>
                                    </ul>
                                    <br>
                                 <form method="POST" action="<?= base_url()?>ReportesEU/ReportePeriodoBalances" target="_blank">
                                     <div class="row form-validation">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="etiquetaa">Fecha de inicio</label>
                                                <div class="input-group">
                                                    <input type="date" id="Fecha_Balance" name="Fecha_Balance" class="form-control">
                                ...
                                <div class="col-md-4">
                                 ...
                                 Reportes por Años
                                    ...
                                    <p>Este reporte genera un documento de registro de balances de ingresos y egresos según el año seleccionada en el cual se muestra la siguiente información:</p>
                                    <ul>
                                    <li>- Fecha </li>
                                    <li>- Operación </li>
                                    <li>- Egreso de dinero</li>
                                    ...
                                    <br>
                                 <form method="POST" action="<?= base_url()?>ReportesEU/ReportePorBalances" target="_blank">
                                     <div class="row form-validation">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="etiquetaa">Año de inicio</label>
                                                <div class="input-group">
                                                    <select id="Fecha_Balance" name="Fecha_Balance" class="form-control">
                                                        <?php
                                                            for ($i=2011; $i < 2071 ; $i++) { 
                                                        ?>
                                                            <option><?= $i?></option>
                                 ...
                                 <div id="divP3"  style="display:none; padding:10px;">
                                     <p>Este reporte genera un documento de registro de balances de ingresos y egresos general en el cual se muestra la siguiente información:</p>
                                    <ul>
                                     <li>- Fecha </li>
                                    <li>- Operación </li>
                                    <li>- Egreso de dinero</li>
